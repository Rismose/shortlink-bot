...
async function bypass(url, id) {
    try {
        ...
        if(html.includes('<title>Loading... | Linkvertise</title>')) linkvertise(url, id); else {if(url.href==resp.url) return client.createMessage(id, {"embed": {"title": "ERROR", "description": `The link provided is invalid.`,"color": 15158332, "footer":{"icon_url":"https://avatars1.githubusercontent.com/u/62519659?s=460&u=4b87fac26aca329573e0ef1fa98502e44e78ee97&v=4","text":"github @ respecting/shortlink-bot, code derived from Sainan/Universal-Bypass"},"author":{"name":"Shortlink Bot","url":"https://github.com/respecting/shortlink-bot", "icon_url": "https://cdn.discordapp.com/avatars/780857188171644962/0344f614c6e85bef212f77d24631c631.webp?size=128"}}}); client.createMessage(id, {"embed":{"title":"Bypassed the link sucessfully.","color":1964014,"footer":{"icon_url":"https://avatars1.githubusercontent.com/u/62519659?s=460&u=4b87fac26aca329573e0ef1fa98502e44e78ee97&v=4","text":"github @ respecting/shortlink-bot, code derived from Sainan/Universal-Bypass"},"author":{"name":"Shortlink Bot","url":"https://github.com/respecting/shortlink-bot", "icon_url": "https://cdn.discordapp.com/avatars/780857188171644962/0344f614c6e85bef212f77d24631c631.webp?size=128"},"fields":[{"name":"Original Link:","value":"["+url.href+"]("+url.href+")"},{"name":"Bypassed Link:","value":"["+resp.url+"]("+resp.url+")"}]}})}
    } catch {
        client.createMessage(id, {"embed": {"title": "ERROR", "description": `The link provided (${url.href}) is invalid.`,"color": 15158332, "footer":{"icon_url":"https://avatars1.githubusercontent.com/u/62519659?s=460&u=4b87fac26aca329573e0ef1fa98502e44e78ee97&v=4","text":"github @ respecting/shortlink-bot, code derived from Sainan/Universal-Bypass"},"author":{"name":"Shortlink Bot","url":"https://github.com/respecting/shortlink-bot", "icon_url": "https://cdn.discordapp.com/avatars/780857188171644962/0344f614c6e85bef212f77d24631c631.webp?size=128"}}})
    }
}
...
function linkvertise(url, id) {
	...
	fetch('https://publisher.linkvertise.com/api/v1/redirect/link/static'+path).then(r=>r.json()).then(json=>{
    		...
    		let favicon = json.data.link.favicon_url
    	}).then(()=>{fetch('https://publisher.linkvertise.com/api/v1/redirect/link'+path+'/target?serial='+o).then(r=>r.json()).then(json=>{
    			...
    			embed = {
					"embed": {
					        ...
					        "author": {
					            "name": "Shortlink Bot",
					            "url": "https://github.com/respecting/shortlink-bot", "icon_url": "https://cdn.discordapp.com/avatars/780857188171644962/0344f614c6e85bef212f77d24631c631.webp?size=128"
					        },
					        "fields": [{
					                "name": "Original Link:",
...
client.on("messageCreate", (msg) => {
	...
	if(msg.content.startsWith(process.env.prefix+'invite')) {
		client.createMessage(msg.channel.id, {"embed":{"title":"Invite", "description": "[Click me!](https://discord.com/oauth2/authorize?client_id=780857188171644962&scope=bot&permissions=8)", "author": {"name": "Shortlink Bot","url": "https://github.com/respecting/shortlink-bot", "icon_url": "https://cdn.discordapp.com/avatars/780857188171644962/0344f614c6e85bef212f77d24631c631.webp?size=128"}}})
	}
    if(msg.content.startsWith(process.env.prefix+'bypass')) {
    	if(!msg.content.includes(' ')) return client.createMessage(msg.channel.id, {"embed": {"title": "ERROR", "description": `No link was provided. Usage: bypass link`,"color": 15158332, "footer":{"icon_url":"https://avatars1.githubusercontent.com/u/62519659?s=460&u=4b87fac26aca329573e0ef1fa98502e44e78ee97&v=4","text":"github @ respecting/shortlink-bot, code derived from Sainan/Universal-Bypass"},"author":{"name":"Shortlink Bot","url":"https://github.com/respecting/shortlink-bot", "icon_url": "https://cdn.discordapp.com/avatars/780857188171644962/0344f614c6e85bef212f77d24631c631.webp?size=128"}}})
